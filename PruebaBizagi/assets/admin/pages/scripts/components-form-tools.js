var ComponentsFormTools = function () {
    ...
    var handleInputMasks = function () {
        ...
        $("#mask_anoServicio").inputmask("mask", {
            "mask": "99"
        });
        $("#mask_anoServ").inputmask("mask", {
            "mask": "99"
        });
        $("#mask_anoVehiculo").inputmask("mask", {
            "mask": "9999"
        });
        ...
        $("#mask_RDcurrency").inputmask('RD$ 999,999,999.99', {
            numericInput: true
        });
        $("#mask_RDcurrencyMontoaSolicitar").inputmask('RD$ 999,999,999.99', {
            numericInput: true
        });
        $("#mask_RDcurrencyValorVehiculo").inputmask('RD$ 999,999,999.99', {
            numericInput: true
